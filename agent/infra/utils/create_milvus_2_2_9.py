...
collection = create_collection("milian", "milian kownledge")
...
embeddings = [embed_with_str(doc) for doc in documents]
entities = [
    [0 for i in range(len(documents))],
...
query_vector = embed_with_str(query)
